...
void VL53L0X::writeReg(uint8_t reg, uint8_t value)
{
  ...
  myWire->write(reg);
  myWire->write(value);
  last_status = myWire->endTransmission();
}
...
void VL53L0X::writeReg32Bit(uint8_t reg, uint32_t value)
{
  myWire->beginTransmission(address);
  myWire->write(reg);
  myWire->write((value >> 24) & 0xFF); // value highest byte
  myWire->write((value >> 16) & 0xFF);
  myWire->write((value >>  8) & 0xFF);
  myWire->write( value        & 0xFF); // value lowest byte
  last_status = myWire->endTransmission();
}
...
uint8_t VL53L0X::readReg(uint8_t reg)
{
  ...
  myWire->requestFrom(address, (uint8_t)1);
  value = myWire->read();
...
uint16_t VL53L0X::readReg16Bit(uint8_t reg)
{
  ...
  myWire->requestFrom(address, (uint8_t)2);
...
uint32_t VL53L0X::readReg32Bit(uint8_t reg)
{
  ...
  myWire->requestFrom(address, (uint8_t)4);
  value  = (uint32_t)myWire->read() << 24; // value highest byte
  value |= (uint32_t)myWire->read() << 16;
  value |= (uint16_t)myWire->read() <<  8;
  value |=           myWire->read();       // value lowest byte
...
void VL53L0X::readMulti(uint8_t reg, uint8_t * dst, uint8_t count)
{
  ...
  myWire->requestFrom(address, count);
